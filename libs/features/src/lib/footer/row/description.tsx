  ...
  return (
    <>
      <Text size="sm">
        ...
        <Link href="/">licence</Link>). Deriv (BVI) Ltd is licensed by the
        British Virgin Islands Financial Services Commission (
        <Link href="/">licence</Link>). Deriv (V) Ltd is licensed by the Vanuatu
        Financial Services Commission (<Link href="/">licence</Link>). Deriv
        (SVG) LLC has a registered office at First Floor, SVG Teachers Credit
        Union Uptown Building, Corner of James and Middle Street, Kingstown
        P.O., St Vincent and the Grenadines. Deriv.com Limited is the holding
        company for the above subsidiaries with the registration number 71479
        and the registered address is located at 2nd Floor, 1 Cornet Street, St
